...
export const productsSlice = createSlice({
  ...
  reducers: {
    sortProductsByCategory: (state) => {
      const sorted = [...state.products].sort((a, b) =>a.category.id - b.category.id);
...
export const {sortProductsByCategory, sortProductsByPrice, filterProduct,emptyProducts} =  productsSlice.actions
